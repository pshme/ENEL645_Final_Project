...
PATH_BEST = './density_net_three.pth' # Path to save the best model
...
class_balance = torch.tensor([0.46, 0.31, 0.22]) # Manually importing the category ratios A, B, C, D
...
save_saliency_map(AB_image_path, model, "saliency_3class_AB.png")
save_saliency_map(C_image_path, model, "saliency_3class_C.png")
save_saliency_map(D_image_path, model, "saliency_3class_D.png")