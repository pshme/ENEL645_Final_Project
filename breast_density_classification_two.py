...
PATH_BEST = './density_net_two.pth' # Path to save the best model
...
class_balance = torch.tensor([0.46, 0.53]) # Manually importing the category ratios A, B, C, D
...
print(classification_report(fold_val_labels[best_fold_idx], fold_val_predictions[best_fold_idx], target_names=["AB", "CD"]))
...
print("\nClassification Report:")
print(classification_report(test_labels, test_predictions, target_names=["AB", "CD"]))
...
AB_image_path = r"/home/anhela.francees/Density_Classification_ML/MW_DATA/TEST/LASER1_RCC_sep0p0554937m_1686246092357.png"
CD_image_path = r"/home/anhela.francees/Density_Classification_ML/MW_DATA/TEST/CHEMO16_RCC_sep0p034711900000000007_1723479334097.png"
save_saliency_map(AB_image_path, model, "saliency_2class_AB.png")
save_saliency_map(CD_image_path, model, "saliency_2class_CD.png")